...
parser = argparse.ArgumentParser(description='Automation of creating and updating STM32CubeMX-PlatformIO projects. '\
											 'Requirements: Platformio CLI or PlatformIO Shell Commands '\
											 '(Menu -> PlatformIO -> Install Shell Commands), Python ver. >= 3.5.')
...
if not len(sys.argv) > 1:
	...
	# handle /path/to/proj and /path/to/proj/ cases
