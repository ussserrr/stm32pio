...
def _get_version_from_scm() -> str:
    try:
        import setuptools_scm  # dev-only dependency
    except ImportError:
        return 'portable (not-installed)'
    else:
...
def get_version() -> str:
    ...
    if sys.version_info >= (3, 8):
        ...
        try:
            ...
            # stm32pio is not installed (run from sources)
        ...
        try:
            ...
            # Version file is not available, most likely we are not installed
            return _get_version_from_scm()
        else:
