...
def clean_run(test):
    ...
    be done using setUp method of unittest. Also, we assume that stm32pio.util.clean() does not contain any errors
    itself :)
    """
    def wrapper(self):
        stm32pio.util.clean(project_path)
        return test(self)
    return wrapper
...
class Test(unittest.TestCase):
    ...
    def test_generate_code(self):
        ...
        """
        stm32pio.util.generate_code(project_path)
    ...
    def test_pio_init(self):
        ...
        """
        stm32pio.util.pio_init(project_path, board)
    ...
    def test_patch_platformio_ini(self):
        ...
        stm32pio.util.patch_platformio_ini(project_path)
    ...
    def test_build_should_raise(self):
        ...
        with self.assertRaisesRegex(Exception, "PlatformIO build error",
            ...
            stm32pio.util.pio_build(project_path)
    ...
    def test_build(self):
        ...
        result = stm32pio.util.pio_build(project_path)
    ...
    def test_run_editor(self):
        ...
        Call the editors
        """
        stm32pio.util.start_editor(project_path, 'atom')
        stm32pio.util.start_editor(project_path, 'code')
        stm32pio.util.start_editor(project_path, 'subl')
    ...
    def test_file_not_found(self):
        ...
        with self.assertRaises(FileNotFoundError, msg="FileNotFoundError was not raised"):
            stm32pio.util._get_project_path(not_existing_path)
